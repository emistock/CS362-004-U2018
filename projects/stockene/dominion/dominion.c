...
int play_adventurer(int currentPlayer, struct gameState *state, int temphand[], int drawntreasure, int cardDrawn, int z)
{
...
int play_mine(int currentPlayer, int choice1, int choice2, struct gameState *state, int j, int handPos, int i)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
        ...
        {
        case adventurer:
                play_adventurer(currentPlayer, state, temphand, drawntreasure, cardDrawn, z);
        ...
        case mine:
                play_mine(currentPlayer, choice1, choice2, state, j, handPos, i);
        case remodel:
                play_remodel(currentPlayer, choice1, choice2, state, j, i, handPos);

        case smithy:
                play_smithy(currentPlayer, state, handPos, i);

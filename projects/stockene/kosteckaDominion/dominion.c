...
int adventurerCard(int drawntreasure, struct gameState *state, int currentPlayer, int temphand[], int z, int cardDrawn);
int council_roomCard(int i, int handPos, int currentPlayer, struct gameState *state);
int mineCard(int j, struct gameState *state, int currentPlayer, int i, int choice1, int choice2, int handPos);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
	adventurerCard(drawntreasure, state, currentPlayer, temphand, z, cardDrawn);

    case council_room:
	council_roomCard(i, handPos, currentPlayer, state);
    ...
    case mine:
	mineCard(j, state, currentPlayer, i, choice1, choice2, handPos);
